            ...
            <form class="form-horizontal" action="controlador" method="POST"  onabort="" onsubmit="sucesso();">
              ...
              <fieldset>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input id="nome" name="numero" type="text" placeholder="Digite o número do Ônibus"
                  ...
                  <div class="table-responsive">
                    <table id="mytable" class="table table-bordred table-striped">
                      ...
                      <% for (Onibus o : onibus){ %>
                        <tr>
                          <td>
                            <INPUT TYPE="radio" NAME="OPCAO" VALUE="<%=o.getId()%>" >
                          </td>
                          <td><%=o.getNumero() %></td>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   ...
                   <div class="form-group">
                     Número<input class="form-control"  type="text" readonly="readonly" value="<%=o.getNumero() %>" >
                      Nome da Rota<input class="form-control" type="text" readonly="readonly" value="<%=o.getRota().getNome() %>" >
                       Empresa<input class="form-control" type="text" readonly="readonly" value="<%=o.getRota().getEmpresa().getRazao() %>" >
                    </div>
